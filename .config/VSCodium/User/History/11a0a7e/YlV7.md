...
> [!note]Questions:
>
> 1. _Disable Wi-fi powersave?_: **Yes**.
> 2. _Install the packages?_: **Yes**.
> 3. _Copy the config files?_: **Yes**.
> 4. _Install \_Starship_ _shell?_: Personal (**Yes**.)
> 5. _Install \_Asus_ _ROG software support?_: In my case (**No**.)
